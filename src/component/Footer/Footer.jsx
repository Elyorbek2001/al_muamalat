    ...
    return (
        <>
            <div className="w-full text-center px-6 md:px-32 pt-24 pb-8 bg-gray-50">
                <div className="rounded-2xl overflow-hidden shadow grid grid-cols-1 md:grid-cols-2 w-full h-[450px] ">
                    {/* LEFT BOX */}
                    <div className="px-8 text-[#D28527] bg-[#FAE9D3] text-start shadow">
                        <h4 className="font-medium text-3xl py-8 pb-4">
                    ...
                    {/* FORM BOX */}
                    <div className=" bg-[#F9F7F3] border shadow space-y-4 text-left px-8 py-8">
                        <h2 className="text-3xl font-semibold">Free Consultation</h2>
